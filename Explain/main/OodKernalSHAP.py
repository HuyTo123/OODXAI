...
class OodKernelExplainer(OODExplainerBase):
    ...
    def _parse_labels_from_line(line):
        ...
        try:
            ...
            return []
    def _load_ground_truth_staticscal(self, relative_file_path='test/model_stats_MSP.npz'):
        """
    ...
    def _calculate_hit_rate(gt_labels, top_k_labels):
        ...
        return hit_rate
    def run_evaluation_experiment(self, num_runs=10):
        """
        ...
        for img_idx, gt_unsafe_labels in tqdm(gt_data, desc="Đánh giá các ảnh"):
            ...
            for _ in range(num_runs):
                ...
                p, r, f1, acc = self._calculate_metrics(gt_unsafe_labels, pred_unsafe_c0, n_segments_trained)
